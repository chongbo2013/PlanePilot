 ...
 * @author davedes
 * Seb: just copied the version of SockwaveDemo and placed it into the core project for testing in other platforms
 */
public class Shockwave implements ApplicationListener {
