 ...
 * @author davedes
 */
public class BumpDemo implements ApplicationListener {
    ...
    public static void main(String[] args) {
        ...
        cfg.height = 480;
        cfg.resizable = false;
        new LwjglApplication(new BumpDemo(), cfg);
    }
    ...
    @Override
    public void create() {
        rock = new Texture(Gdx.files.internal("airplane/PLANE_8_N.png"));
        rockNormals = new Texture(Gdx.files.internal("airplane/PLANE_8_N_NRM.png"));
